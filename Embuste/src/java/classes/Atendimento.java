...
public class Atendimento {
    ...
    public Atendimento(int atendimento_codigo, Date atendimento_data_hora, String atendimento_cpf_cliente, String atendimento_situacao, int atendimento_cod_produto, int atendimento_cod_tipo_atendimento, String atendimento_descricao, String atendimento_solucao) {
    ...
    public String toString() {
        return "Atendimento{" + "atendimento_codigo=" + atendimento_codigo + ", atendimento_data_hora=" + atendimento_data_hora + ", atendimento_cpf_cliente=" + atendimento_cpf_cliente + ", atendimento_situacao=" + atendimento_situacao + ", atendimento_cod_produto=" + atendimento_cod_produto + ", atendimento_cod_tipo_atendimento=" + atendimento_cod_tipo_atendimento + ", atendimento_descricao=" + atendimento_descricao + ", atendimento_solucao=" + atendimento_solucao + '}';
    }
